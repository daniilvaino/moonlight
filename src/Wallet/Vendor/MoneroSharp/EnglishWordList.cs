// Vendored data: the English mnemonic word list.
//
// From MoneroSharp (MIT), which took it from monero. Data, not code — the only
// thing here that could be wrong is a word, and there are 1626 of them.

namespace Moonlight.Wallet.Vendor;

internal static class EnglishWordList
{
    /// <summary>Words are distinguished by their first three characters.</summary>
    public const int UniquePrefixLength = 3;
